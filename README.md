...
The available data for some satellites is only upto the first 35 days of 2023. This, along with the number of satellites taken into consideration (442 satellites) is the reason for the analysis being limited to January 2023.
