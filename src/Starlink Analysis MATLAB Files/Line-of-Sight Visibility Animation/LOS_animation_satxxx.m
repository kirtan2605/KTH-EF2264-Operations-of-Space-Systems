...
% YOU NEED TO CHANGE SATELLITE NUMBER AT 2 PLACES


% Define the coordinates of the satellites over time
MATS_coords = load("Satellite_positions/MATS.txt");
Starlink_coords = load("Satellite_positions/Starlink_012.txt");   % CHANGE SATELLITE NUMBER HERE

% convert distances to km/home/kirtan/github/KTH-EF2264-Operations-of-Space-Systems/src/datafiles/StarlinkPositions-NumpyArray
...
line_of_sight_steps = LOS_visibility_data.LOS_visibility_data_v1(:,12); % CHANGE SATELLITE NUMBER HERE
