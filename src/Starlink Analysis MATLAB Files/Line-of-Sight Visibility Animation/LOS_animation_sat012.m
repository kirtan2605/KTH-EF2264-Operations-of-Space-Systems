...
Starlink_coords = load("Satellite_positions/Starlink_025.txt");   % CHANGE SATELLITE NUMBER HERE
...
line_of_sight_steps = LOS_visibility_data.LOS_visibility_data_v1(:,25); % CHANGE SATELLITE NUMBER HERE
