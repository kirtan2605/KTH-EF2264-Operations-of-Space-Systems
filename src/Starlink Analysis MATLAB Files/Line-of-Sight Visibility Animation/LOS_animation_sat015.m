...
Starlink_coords = load("Satellite_positions/Starlink_015.txt"); % [x2, y2, z2] coordinates over time
...
line_of_sight_steps = LOS_visibility_data.LOS_visibility_data_v1(:,15); % Binary vector of the same length as the coordinates
